...
var fn = function () {
  ...
  axs.color.findIntersection = function (a, b) {
    var c = [a.a.x - b.p0.x, a.a.y - b.p0.y, a.a.z - b.p0.z],
        d = axs.color.invert3x3Matrix([[a.a.x - a.b.x, b.p1.x - b.p0.x, b.p2.x - b.p0.x], [a.a.y - a.b.y, b.p1.y - b.p0.y, b.p2.y - b.p0.y], [a.a.z - a.b.z, b.p1.z - b.p0.z, b.p2.z - b.p0.z]]),
  ...
  axs.constants.TAG_TO_IMPLICIT_SEMANTIC_INFO = {
    ...
    IFRAME: [{
      ...
      role: "",
      allowed: ["application", "document", "img", "presentation", "group"],
  ...
  axs.properties.findTextAlternatives = function (a, b, c, d) {
    ...
    e && axs.utils.elementIsHtmlControl(c) && (f = c.ownerDocument.defaultView, c instanceof f.HTMLInputElement && ("text" == c.type && c.value && 0 < c.value.length && (b.controlValue = {
      text: c.value
    }), "range" == c.type && (b.controlValue = {
      text: c.value
  ...
  axs.AuditRules.addRule({
    ...
    relevantElementMatcher: function (a, b) {
      b.idrefs.length && !b.hidden && this.relatedElements.push({
        element: a,
        flags: b
      });
