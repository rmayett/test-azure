...
describe("Messages", function () {
  ...
  describe("about call context", function () {
    it("should be correct for the basic case", function () {
      ...
      spy.call(badContext);
      var expected = "expected spy to have been called with {  } as this, but it was called with " + spy.printf("%t") + " instead";
      expect(function () {
    ...
    it("should be correct for the always case", function () {
      ...
      spy.call(badContext);
      var expected = "expected spy to always have been called with {  } as this, but it was called with " + spy.printf("%t") + " instead";
      expect(function () {
  ...
  describe("about throwing", function () {
    it("should be correct for the basic cases", function () {
      ...
      expect(function () {
        throwingSpy.should.have.thrown({
          message: "x"
        });
      }).to.throw('expected spy to have thrown { message: "x" }');
      expect(function () {
        throwingSpy.getCall(0).should.have.thrown({
          message: "x"
        });
      }).to.throw('expected spy to have thrown { message: "x" }');
    });
    ...
    it("should be correct for the always cases", function () {
      ...
      expect(function () {
        throwingSpy.should.have.always.thrown({
          message: "x"
        });
  ...
  describe("when used on a non-spy/non-call", function () {
    function notSpy() {// Contents don't matter
    }
